...
export function OverlaysKitchenSinkExample() {
  return (
    <View padding="size-250" width="100%">
      <Flex direction="column" gap="size-400">
        <View>
          ...
          >
            Showcase of all overlay components: tooltips, popovers, dialogs, alert dialogs,
            contextual help, and fullscreen actions.
          </p>
        </View>
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="Popover"
            subtitle="anchored floating dialog with placement variants"
          />
          <Flex direction="row" gap="size-200" wrap alignItems="center">
            <Popover>
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="CustomPopover"
            subtitle="react-aria-components variant with optional arrow"
          />
          <Flex direction="row" gap="size-200" wrap alignItems="center">
            <CustomPopover
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="Dialog"
            subtitle="modal, dismissable, and popover-type variants"
          />
          <Flex direction="row" gap="size-200" wrap alignItems="center">
            <DialogTrigger>
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="AlertDialog"
            subtitle="confirmation, destructive, and warning variants"
          />
          <Flex direction="row" gap="size-200" wrap alignItems="center">
            <DialogTrigger>
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            ...
            subtitle="help and info variants for form labels"
          />
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            ...
            subtitle="fullscreen takeover dialog for immersive editing"
          />
          <Flex direction="row" gap="size-100" alignItems="center">
