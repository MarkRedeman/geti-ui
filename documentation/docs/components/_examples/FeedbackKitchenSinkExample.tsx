...
// ---------------------------------------------------------------------------
// Inline SVG substitute for the Magnify workflow icon
// (avoids @spectrum-icons/workflow import in docs context)
// ---------------------------------------------------------------------------
...
export function FeedbackKitchenSinkExample() {
  return (
    <View padding="size-250" width="100%">
      {/* ToastContainer must be rendered once in the tree to display toasts */}
      ...
      <Flex direction="column" gap="size-400">
        <View>
          ...
          >
            Showcase of all feedback and status components: progress indicators, alerts, badges,
            and loading states.
          </p>
        </View>
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="StatusLight"
            subtitle="semantic and extended color variants"
          />
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="InlineAlert"
            subtitle="contextual alert messages with semantic variants"
          />
          <Flex direction="column" gap="size-150">
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="Skeleton"
            subtitle="rectangle and circle loading placeholders"
          />
          <Flex direction="column" gap="size-150">
            <div>
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            ...
            subtitle="empty state with illustration, heading, and body text"
          />
          <View
            borderWidth="thin"
        ...
        <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
          <SectionHeading
            title="Toast"
            subtitle="positive, negative, info, and neutral notification toasts"
          />
