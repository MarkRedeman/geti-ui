  ...
  return (
    <Flex direction="column" gap="size-200">
      ...
      <Flex direction="row" gap="size-200" wrap>
        <PhotoPlaceholder name="Alice Nguyen" indicator="alice@example.com" />
        <PhotoPlaceholder name="Bob Müller" indicator="bob@example.com" />
        <PhotoPlaceholder name="Carol Smith" indicator="carol@example.com" />
      </Flex>
    </Flex>
  );
}
