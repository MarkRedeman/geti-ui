...
export const highestCorner = (shape: RotatedRect): Vec2.Vec2 => sortedCorners(shape)[0] as Vec2.Vec2;
export const lowestCorner = (shape: RotatedRect): Vec2.Vec2 =>
    sortedCorners(shape)[sortedCorners(shape).length - 1] as Vec2.Vec2;
