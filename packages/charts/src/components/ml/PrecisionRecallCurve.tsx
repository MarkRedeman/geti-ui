...
export interface PrecisionRecallCurveSeriesConfig {
    /** Precision values key in data row. */
    dataKey: string;
    /** Legend/display name. */
    name?: string;
...
export interface PrecisionRecallCurveProps {
    /** Curve points table; each row includes recall and one-or-more precision series fields. */
    data: Record<string, unknown>[];
    /** Curve series definitions. */
    series: [PrecisionRecallCurveSeriesConfig, ...PrecisionRecallCurveSeriesConfig[]];
    /** X axis key for recall values. @default 'recall' */
    xAxisKey?: string;
    ...
    animate?: boolean;
    /** Show no-skill baseline line. @default false */
    showBaseline?: boolean;
    /** Baseline precision value (e.g. positive prevalence). @default 0.5 */
