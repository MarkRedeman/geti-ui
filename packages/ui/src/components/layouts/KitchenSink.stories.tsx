    ...
    <View padding="size-400">
        <Flex direction="column" gap="size-400">
            ...
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Accordion" subtitle="default, multiple-expanded, and quiet variants" />
            ...
            {/* ── Card ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Card" subtitle="default, selectable, selected, and disabled states" />
            ...
            {/* ── Disclosure ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Disclosure" subtitle="collapsed, expanded, quiet, and disabled states" />
                <Flex direction="row" gap="size-400" wrap alignItems="start">
                    <View minWidth="size-4600">
            ...
            {/* ── Flex ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Flex" subtitle="row, column, centered alignment, and wrapping layouts" />
            ...
            {/* ── Grid ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Grid" subtitle="3-column, 2-column, and centered alignment" />
                <Flex direction="column" gap="size-300">
                    <View>
            ...
            {/* ── Well ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Well" subtitle="default, code example, and region role" />
