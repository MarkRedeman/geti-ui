...
const FormKitchenSink = () => (
    <View padding="size-400">
        <Flex direction="column" gap="size-400">
            ...
            {/* ── Selection controls ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Selection Controls" subtitle="CheckboxGroup, RadioGroup, Switch" />
                <Grid columns={['1fr', '1fr']} gap="size-300" UNSAFE_style={{ alignItems: 'start' }}>
                    <Flex direction="column" gap="size-250">
                        <div>
            ...
            {/* ── Sliders ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Sliders" subtitle="Slider (single handle) and RangeSlider (dual handle)" />
            ...
            {/* ── Form wrapper ── */}
            <View padding="size-300" backgroundColor="gray-50" borderRadius="medium">
                <SectionHeading title="Form" subtitle="Form wrapper with labelled inputs and submit/reset actions" />
...
type Story = StoryObj<typeof FormKitchenSink>;
