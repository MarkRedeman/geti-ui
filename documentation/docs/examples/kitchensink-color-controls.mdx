...
<ExampleCard title="Picker &amp; ComboBox" code={`<Picker label="Framework" defaultSelectedKey="react">...</Picker>`}>
...
<ExampleCard title="Color Controls" code={`<ColorArea defaultValue="hsb(220, 80%, 90%)" xChannel="saturation" yChannel="brightness" />`}>
